...
def perform
  #Méthode de classe pour pouvoir souhaiter la bienvenue avant de créer un objet
  Game.greeting
  ...
  puts "Tes pires ennemies viennent d'être créés ! GRRrrrr !".bg_blue.bold, "Ils sont #{my_game.enemies_in_sight.length}".bg_blue.bold #bg_blue.bold est un trick pour avoir de la couleur
